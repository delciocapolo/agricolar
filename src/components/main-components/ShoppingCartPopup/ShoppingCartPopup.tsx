...
const ShoppingCartPopup = () => {
    ...
    const handleClickShoppingPopupContainer: MouseEventHandler<HTMLElement> = (event) => {
        event.stopPropagation();
    }
    return (
        <BG onClick={handleCloseContainer} ref={BGRef} className="shoppingcart-popup">
            <ShoppingCartPopupContainer className="d-flex" onClick={handleClickShoppingPopupContainer}>
                <Frame227>
                    <Frame229 className="d-flex">
                        <TextFram229>Carrinho <SubTextFrame229>[{4}]</SubTextFrame229></TextFram229>
                        <ButtonCloseFram229 className="d-flex" onClick={handleCloseContainer}>
                            <Cancel01Icon size={20} />
                        </ButtonCloseFram229>
                    </Frame229>
                    {
                        [1, 2, 3, 5, 9, 3, 2, 4, 1, 2, 5, 2, 3, 5, 2, 3].map((_) => (
                ...
                <Fram228>
                    <TextFrame229Container className="d-flex">
                        <TextDescribeFrame229>{4} produtos</TextDescribeFrame229>
                        <TextPriceFrame229>{270}kz</TextPriceFrame229>
                    </TextFrame229Container>
