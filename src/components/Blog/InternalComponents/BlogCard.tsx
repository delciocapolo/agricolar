        ...
        <BlogCardContainer className="d-flex">
            ...
            <ContentBase className="d-flex">
                <Content className="d-flex">
                    ...
                    <Text>Nulla libero lorem, euismod venenatis nibh sed, sodales dictum ex. Etiam nisi augue, malesuada et pulvinar at, posuere eu neque.</Text>
                </Content>
                <Link href="#" className="d-flex">ler mais <ArrowRight size={23} /></Link>
            </ContentBase>
        </BlogCardContainer>
    );
};
