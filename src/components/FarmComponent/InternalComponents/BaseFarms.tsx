...
export const ListFarms = () => {
  ...
  const listFarms = [
    {
      name: "Grupo Sagrada Fazenda",
      createdAt: new Date().toLocaleString(),
      fazendeiro: "Edmilson Candongo",
      descricao: "Criando uma vida mais saudavel para as nossas comunidades",
    },
    {
      name: "Fazenda Familiar Capolo",
      createdAt: new Date().toLocaleString(),
      fazendeiro: "Delcio Capolo",
      descricao:
        "Criando o melhor e o maior. Somos os melhores porque eles escolhem à nós.",
    },
    {
      name: "Grupos Fazendas 365",
      createdAt: new Date().toLocaleString(),
      fazendeiro: "Mario Onofre",
      descricao: "Produzindo e a transformar",
    },
    {
      name: "Novos Horizontes",
      createdAt: new Date().toLocaleString(),
      fazendeiro: "Caio Teca",
    },
  ];
            ...
            <CardOverlayContainer>
              <CardHeader>
                ...
                <CardHeaderText>
                  ...
                  <TagLine>{farm.fazendeiro}</TagLine>
                  <CardStatus>criada: {farm.createdAt}</CardStatus>
                </CardHeaderText>
              </CardHeader>
              {"descricao" in farm && (
                <CardDescription>{farm.descricao}</CardDescription>
              )}
            </CardOverlayContainer>
          </LinkFarm>
        </ItemFarm>
