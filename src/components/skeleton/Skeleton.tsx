    ...
    <section className="skeleton">
      <article className="banner-gennesis b-image">
        <div className="container d-grid">
          <div className="content d-grid">
            <h1 className="title">
              o papel da tecnologia em revolucionar a agricultura
            </h1>
            <h3 className="subtitle">
              o papel da tecnologia em revolucionar a agricultura - o papel da
              tecnologia em revolucionar a agricultura
            </h3>
          </div>
      ...
      <article className="history">
        <div className="container d-grid">
          <div className="content d-grid">
            <h1 className="title">
              nossa paixão pela agricultura alimentando o crescimento e
              sustentando o futuro
            </h1>
            <h3 className="subtitle">
              li europan lingues es membres del sam familie. lor separat
              existentie es un myth. por scientie, musical, sport etc. litot
      ...
      />
      <Service
        title="nossos produtos caracterizados"
        description="li europan lingues es membres del sam familie. lor separat existentie es un myth. por scientie, musical, sport etc. litot europa usa li sam vocabular"
        services={services}
        key={uuidv4()}
        actived
